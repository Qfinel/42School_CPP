...
/*   Updated: 2022/12/09 14:21:06 by jtsizik          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(AForm &paper)
{
	...
	if (paper.getIsSigned())
		...
		std::cout << this->name << " couldn't sign " << paper.getName() << " because bureaucrat's grade is too low" << std::endl;
}
...
void Bureaucrat::executeForm(AForm const & form)
{
	...
	{
		std::cout << "Error: Bureucrat " << this->name << " couldn't execute the form" << std::endl;
	}
}